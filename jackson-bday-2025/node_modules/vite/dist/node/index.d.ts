...
import { ModuleRunnerTransport } from "vite/dist/node/moduleRunnerTransport-BWUZBVLX";
import { ConnectedPayload, CustomPayload, CustomPayload as hmrPayload_CustomPayload, ErrorPayload, FullReloadPayload, HMRPayload, HotPayload, HotPayload as hmrPayload_HotPayload, PrunePayload, Update, UpdatePayload } from "vite/types/hmrPayload";
import { CustomEventMap, InferCustomEventPayload, InferCustomEventPayload as hmrPayload_InferCustomEventPayload, InvalidatePayload } from "vite/types/customEvent";
...
import { Terser, TerserMinifyOptions } from "vite/types/internal/terserOptions";
import * as PostCSS from "postcss";
import { LightningCSSOptions, LightningCSSOptions as lightningcssOptions_LightningCSSOptions } from "vite/types/internal/lightningcssOptions";
import { LessPreprocessorBaseOptions, SassModernPreprocessBaseOptions, StylusPreprocessorBaseOptions } from "vite/types/internal/cssPreprocessorOptions";
import { GeneralImportGlobOptions, ImportGlobFunction, ImportGlobOptions, KnownAsTypeMap } from "vite/types/importGlob";
import { ChunkMetadata, CustomPluginOptionsVite } from "vite/types/metadata";
